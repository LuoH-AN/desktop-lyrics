...
- 直连 LRCLIB、QQ 音乐和网易云，按歌名与歌手自动选择可靠的同步歌词与备用封面
- 支持网易云逐字歌词与官方翻译，可切换原文、双语或中文显示；多候选歌词可在悬浮窗内手动切源
